package com.post_hub.refreshing_knowledge_of_SpringBoot.security;
...
import com.post_hub.refreshing_knowledge_of_SpringBoot.service.models.AutethicationConstans;
...
public class JwtTokenProvider {
    ...
    public String generateToken(@NonNull CustomUserDetails userDetails) {
        ...
        claims.put(AutethicationConstans.USER_EMAIL, userDetails.getUserEmail());
